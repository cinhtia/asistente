...
<h4>Fase 2. Creación de la competencia 
	<a tabindex="0" class="btn btn-sm btn-info" role="button" data-toggle="popover" data-placement="bottom" data-trigger="focus" title="Fase 2" data-content=""><i class="fa fa-question"></i></a>
</h4>
<div id="alerta_fase1">
</div>
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
		<input type="hidden" value="<?= $competencia->id_competencia ?>" name="id_competencia" id="id_competencia">
		<h5 style="margin-bottom:5px;">1. Verbo</h5>
		<div class="input-group">
			<input type="text" placeholder="Escriba o seleccione un verbo" id="autocomplete_verbo" class="form-control">
			<button id="btn_abrir_lista_completa_verbos" data-item="verbo" class="btn btn-primary btn-izq-input btn-der-input btn_abrir_lista_completa_item">
				<i class="fa fa-angle-down" aria-hidden="true"></i>
			</button>
			<button id="btn_agregar_verbo_seleccionado" data-item="verbo" class="btn btn-success btn-izq-input btn_agregar_item_seleccionado">
	...
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
		...
		<div class="input-group">
			<input type="text" placeholder="Escriba o seleccione un contenido" id="autocomplete_contenido" class="form-control">
			<button id="btn_abrir_lista_completa_contenidos" data-item="contenido" class="btn btn-primary btn-izq-input btn-der-input btn_abrir_lista_completa_item">
				<i class="fa fa-angle-down" aria-hidden="true"></i>
			</button>
			<button id="btn_agregar_contenido_seleccionado" data-item="contenido" class="btn btn-success btn-izq-input btn_agregar_item_seleccionado">
				<i class="fa fa-check" aria-hidden="true"></i>
			</button>
		</div>
		<br>
	...
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
		...
		<div class="input-group">
			<input type="text" placeholder="Escriba o seleccione un contexto" id="autocomplete_contexto" class="form-control">
			<button id="btn_abrir_lista_completa_contextos" data-item="contexto" class="btn btn-primary btn-izq-input btn-der-input btn_abrir_lista_completa_item">
				<i class="fa fa-angle-down" aria-hidden="true"></i>
			</button>
			<button id="btn_agregar_contexto_seleccionado" data-item="contexto" class="btn btn-success btn-izq-input btn_agregar_item_seleccionado">
				<i class="fa fa-check" aria-hidden="true"></i>
			</button>
	...
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
		...
		<div class="input-group">
			<input type="text" placeholder="Escriba o seleccione un criterio" id="autocomplete_criterio" class="form-control">
			<button id="btn_abrir_lista_completa_criterios" data-item="criterio" class="btn btn-primary btn-izq-input btn-der-input btn_abrir_lista_completa_item">
				<i class="fa fa-angle-down" aria-hidden="true"></i>
			</button>
				<button id="btn_agregar_criterio_seleccionado" data-item="criterio" class="btn btn-success btn-izq-input btn_agregar_item_seleccionado">
				<i class="fa fa-check" aria-hidden="true"></i>
			</button>
		</div>
		<br>
...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="pull-right">
			...
			<button class="btn btn-primary" id="btn_guardar_competencia_fase1" type='button'>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('.btn_agregar_item_seleccionado').off('click').on('click', function (){
			utils.modal.confirm({
				titulo: 'Información',
				contenido: 'Esta opción no está disponible por el momento. Contacte al administrador del sitio para su habilitación.',
				auto_dismiss: true,
		...
		$('#btn_guardar_competencia_fase1').off('click').on('click', function(){
			...
			if(contVerbos.length == 0 || contContenidos.length == 0 || contContextos.length == 0 || contCriterios.length == 0 || strCompetenciaEditable.trim() == ""){
				utils.alert.warning('Faltan algunos valores o no son válidos');
				...
				$.ajax({
					...
					success: function(response){
						...
						console.log(xhr);
						utils.alert.danger('Ha ocurridoun error al guardar');
						// utils.modal.confirm({
						// 	titulo: 'Error',
