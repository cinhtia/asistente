<div class="container">
	<h4>Fase 3. Generación de los componentes</h4>
	...
	<div style="margin: 10px 30px 5px 10px;" class="text-center">
		...
		<h5 id="contenedor_competencia_generada" class="text-primary">
			<strong><?= $this->competencia_unidad->competencia_editable; ?></strong>
		</h5>
	</div>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
		    ...
		    <div class="form-group">
		    	<div class="input-group">
		    		<input type="text" placeholder="Crea un conocimiento aqui" id="input_conocimiento" class="form-control">
		...
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			...
			<div class="form-group">
				<div class="input-group">
					<input type="text" placeholder="Crea una habilidad aqui" id="input_habilidad" class="form-control">
					<span class="input-group-append">
		...
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			...
			<div class="form-group">
				<div class="input-group">
					<input type="text" placeholder="Crea una actitud o valor aqui" id="input_av" class="form-control">
					<span class="input-group-append">
    ...
    $(document).ready(function(){
		...
		$('#btn_guardar_competencia_fase3').off('click').on('click', function (e){
		    ...
		    if(conocimientos.length == 0){
		    	utils.alert.warning('Debes incluir al menos un conocimiento');
		    	correcto = false;
		    }

		    if(habilidades.length == 0){
		    	utils.alert.warning('Debes incluir al menos una habilidad');
		    	correcto = false;
		    }

		    if(actitudesValores.length == 0){
		    	utils.alert.warning('Debes incluir al menos una actitud o valor');
		    	correcto = false;
		    }
		    ...
		    $.ajax({
		        ...
		        success: function(response){
		    		if(response.estado){
		    			...
		    			window.location.replace("<?= ruta('competencia.perfil').'?id='.$this->competencia_unidad->id_competencia_padre.'&frm=1'; ?>");
