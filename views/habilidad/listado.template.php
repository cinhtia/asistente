...
<table class="table table-bordered table striped table-hover">
	...
	<tbody>
		...
		<tr>
			<td><?= $listaItem->descrip_habilidad ?></td>
			<td>
				<div class="dropdown">
				  ...
				  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
				    <a class="dropdown-item btn-editar-item" data-id="<?= $listaItem->id_compo_habilidad; ?>" href="#"><i class="fa fa-edit"></i> Editar</a>
				    <a class="dropdown-item btn-eliminar-item" data-id="<?= $listaItem->id_compo_habilidad; ?>" href="#"><i class="fa fa-trash"></i> Eliminar</a>
				  </div>
				</div>
			</td>
		</tr>
